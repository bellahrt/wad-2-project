...
function logout() {
  ...
  <main id="main">
    ...
    <!-- ======= About Us Section ======= -->
      <section id="about" class="about" style="justify-content: center;">
        <div class="container" >
  



        <div class='h-auto d-inline-block' style="z-index: -1; position: absolute; height: 100vh;  width: 50%; margin:auto; opacity:0.8;">
