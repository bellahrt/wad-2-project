...
<div id= "container" style = 'margin-top:100px;'>
    ...
    <div class="text-dark bg-warning text-center mb-0">
        ...
        <p class='bg-dark text-warning mb-0'> Click on a monument marker to select a place you like to visit!</p>
                        ...
                        <!-- TO DO: take out width -->
    <div class = 'img-fluid mt-0 w-100' id="map-canvas"  style="height:500px;"></div> 

    <div class="d-grid gap-2 d-md-flex justify-content-md-center">
      <h5 class='pt-2'><b id="modeOfTravel">Default Mode: Walking.</b> <b style='color:red;'>Click</b> to select Exercise Mode</h5><br/>    
      <button class="btn btn-primary me-md-2" type="button" onclick='getTravelValue("WALKING")'>Walking</button>
      <button class="btn btn-danger me-md-2" type="button" onclick='getTravelValue("JOGGING")'>Jogging</button>
      <button class="btn btn-success" type="button" onclick='getTravelValue("CYCLING")'>Cycling</button>
    </div>
    <br/>
...
<div class='container'>
  ...
  <div class="card text-dark bg-dark mb-3" >
    ...
    <div class="card-body ">
      ...
      <p id='location'class="card-text text-warning text-center"></p>
    </div>
...
function directionService(latitude,longitude, lat1, lon2, destination){
    ...
    directionsService.route(route,
        ...
        if (status !== 'OK') {
            ...
            document.getElementById('location').innerHTML += "<br/><b>Destination:</b> " + destination + "<br/>Distance is " + directionsData.distance.text + ".";
...
function getTravelValue(mode){
  ...
  modeOfTravel.innerHTML='Travel Mode: ' +mode
}
...
function nutritionCalorie(distance) {
  console.log(travelish)
    ...
    var calorieResult = `<br/><b>Exercise: </b>` + travelish +`<br/><b>Path ` + pathCount + `</b>: Burned ` + calorie + ` calories in ` + duration +` minutes<br/> <div class="btn btn-warning"onclick="insertCal('` + calorie + `')">Go there now</div><br><br>`
    pathCount++
...
function insertCal(calorie ){
  axios.get("insertexercise.php",
      {params:{
        username: username,
